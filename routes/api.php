...
Route::prefix('admin')->name('admin.')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::get('/withdraw/list', [WithdrawRequestController::class, 'listRequests']);
    Route::post('/withdraw/request', [WithdrawRequestController::class, 'requestWithdraw']);
    Route::put('/withdraw/status/{id}', [WithdrawRequestController::class, 'changeStatus']);
    ...
    Route::prefix('seller')->name('seller.')->group(function () {
        Route::post('/bulk-delete', [SellerController::class, 'bulkDelete']);
        ...
        Route::match(['put', 'patch'], '/{seller}', [SellerController::class, 'update']);
        Route::delete('/{employee}', [EmployeeController::class, 'destroy']);
        Route::get('/export', [EmployeeController::class, 'export']);
        Route::post('/change-password/{employee}', [EmployeeController::class, 'changePassword']);
        Route::post('/change-image/{employee}', [EmployeeController::class, 'changeImage']);
