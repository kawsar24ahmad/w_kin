<template>
    ...
    <div id="sidebar"
        ...
        <div class="drawer-header">
            <h3 class="drawer-title">{{ $t("menu.sellers") }}</h3>
        ...
        <div class="drawer-body">
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="company_name" class="db-field-title required">Company Name</label>
                        <input v-model="props.form.company_name" v-bind:class="errors.company_name ? 'invalid' : ''" type="text"
                            id="company_name" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.company_name">{{
                            errors.company_name[0]
                        }}</small>
                    </div>
                    <div class="form-col-12 sm:form-col-6">
                        <label for="category" class="db-field-title required">Category</label>
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label for="commission" class="db-field-title required">Commission</label>
                        <input v-model="props.form.commission" v-bind:class="errors.commission ? 'invalid' : ''" type="number"
                            id="commission" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.commission">{{
                            errors.commission[0]
                        }}</small>
                    </div>
                    <div class="form-col-12 sm:form-col-6">
    <label for="photo" class="db-field-title required">Photo</label>
    <input ref="photo" v-bind:class="errors.photo ? 'invalid' : ''"
        type="file" id="photo" class="db-field-control" />
    <small class="db-field-alert" v-if="errors.photo">
        {{ errors.photo[0] }}
    </small>
</div>

<div class="form-col-12 sm:form-col-6">
    <label for="license_photo" class="db-field-title required">License Photo</label>
    <input ref="license_photo" v-bind:class="errors.license_photo ? 'invalid' : ''"
        type="file" id="license_photo" class="db-field-control" />
        <small class="db-field-alert" v-if="errors.photo">
        {{ errors.license_photo[0] }}
    </small>
</div>

<div class="form-col-12 sm:form-col-6">
    <label for="nid_photo" class="db-field-title required">NID Photo</label>
    <input ref="nid_photo" v-bind:class="errors.nid_photo ? 'invalid' : ''"
        type="file" id="nid_photo" class="db-field-control" />
        <small class="db-field-alert" v-if="errors.photo">
        {{ errors.nid_photo[0] }}
    </small>
</div>
...
export default {
    ...
    computed: {
        ...
        addButton: function () {
              return {title: this.$t("button.add_seller")}
        }
    },
    mounted() {
    ...
    methods: {
        ...
        reset: function () {
            ...
            this.$store.dispatch("seller/reset");
            this.errors = {};
            ...
            if (this.$refs.license_photo) this.$refs.license_photo.value = null;
            if (this.$refs.nid_photo) this.$refs.nid_photo.value = null;
        ...
        save: function () {
            ...
            try {
                const tempId = this.$store.getters["seller/temp"].temp_id;
                if (this.$refs.photo && this.$refs.photo.files[0]) {
                    this.props.form.photo = this.$refs.photo.files[0];
                }

                if (this.$refs.license_photo && this.$refs.license_photo.files[0]) {
                    this.props.form.license_photo = this.$refs.license_photo.files[0];
                }

                if (this.$refs.nid_photo && this.$refs.nid_photo.files[0]) {
                    this.props.form.nid_photo = this.$refs.nid_photo.files[0];
                }

                this.loading.isActive = true;
                this.$store
                    .dispatch("seller/save", this.props)
                    .then((res) => {
                        useCanvas().closeCanvas('sidebar');
                        this.loading.isActive = false;
                        alertService.successFlip(tempId === null ? 0 : 1, this.$t("menu.sellers"));
                        this.props.form = {
                            name: "",
                            email: "",
                            phone: "",
