<template>
    ...
    <div class="col-12" v-if="Object.entries(employee).length > 0">
        ...
        <div class="flex flex-col items-start sm:flex-row sm:items-center gap-1.5 mb-6">
            ...
            <button type="button" @click="handleTab($event, '#seller_info', '.profile-tabBtn', '.profile-tabDiv', 'active')"
                class="profile-tabBtn w-full justify-start sm:w-fit inline-flex items-center sm:justify-center gap-2 h-[38px] py-2 px-4 rounded-md text-[#6E7191] stroke-[#6E7191]">
                <i class="lab lab-line-location"></i>
                <span class="capitalize text-sm">Seller Info</span>
            </button>
            ...
            <button type="button" @click="handleTab($event, '#products', '.profile-tabBtn', '.profile-tabDiv', 'active')"
                class="profile-tabBtn w-full justify-start sm:w-fit inline-flex items-center sm:justify-center gap-2 h-[38px] py-2 px-4 rounded-md text-[#6E7191] stroke-[#6E7191]">
                <i class="lab lab-line-reserve"></i>
                <span class="capitalize text-sm">Products</span>
            </button>
        </div>
        ...
        <div id="seller_info" class="profile-tabDiv">
    <div class="db-card">

        <div class="db-card-header">
            <h3 class="db-card-title">Seller Information</h3>
        </div>
        ...
        <div class="db-card-body">
            ...
            <div class="row py-2">
                ...
                <!-- Seller Photo -->
                <div class="col-12 sm:col-4 !py-1.5">
                    <div class="db-list-item p-0 text-center">
                        <span class="db-list-item-title block mb-1">Profile Photo</span>
                        <img :src="previewImage ?? '/images/required/profile.png'"
                             class="w-[120px] h-[120px] object-cover rounded-lg mx-auto"
                             alt="Seller Photo" />
                    </div>
                </div>
             ...
             <div class="col-12 sm:col-4 !py-1.5">
    <div class="db-list-item p-0 text-center">
        <span class="db-list-item-title block mb-1">NID</span>
        <img :src="employee.seller_info?.nid_photo ?? '/images/required/profile.png'"
             class="w-full max-w-[240px] h-auto object-contain rounded-lg mx-auto"
             alt="NID Photo" />
    </div>
</div>
...
<div class="col-12 sm:col-4 !py-1.5">
    <div class="db-list-item p-0 text-center">
        <span class="db-list-item-title block mb-1">License</span>
        <img :src="employee.seller_info?.license_photo ?? '/images/required/profile.png'"
             class="w-full max-w-[240px] h-auto object-contain rounded-lg mx-auto"
             alt="License Photo" />
    </div>
</div>
                ...
                <div class="col-12 !py-2 mt-4">
                    <div class="db-list-item p-0 flex flex-wrap gap-4">
                        <span class="db-list-item-title w-1/4">Company Name:</span>
                        <span class="db-list-item-text w-3/4">{{ employee.seller_info?.company_name }}</span>
                    </div>

                    <div class="db-list-item p-0 flex flex-wrap gap-4 mt-2">
                        <span class="db-list-item-title w-1/4">Category:</span>
                        <span class="db-list-item-text w-3/4">{{ employee.seller_info?.category }}</span>
                    </div>

                    <div class="db-list-item p-0 flex flex-wrap gap-4 mt-2">
                        <span class="db-list-item-title w-1/4">Commission:</span>
                        <span class="db-list-item-text w-3/4">{{ employee.seller_info?.commission }}%</span>
                    </div>
                </div>
    ...
    <div id="products" class="profile-tabDiv">
    <div class="db-card">

        <div class="db-card-header">
            <h3 class="db-card-title">Seller Products</h3>
        </div>

        <div class="db-card-body">

            <!-- SUMMARY -->
            <div class="row mb-5" v-if="sellerProducts">
                ...
                <div class="col-12 md:col-4">
                    <div class="border flex items-center gap-4 p-4 rounded-lg">
                        <div class="bg-[#F7F7F7] w-12 h-12 rounded-full flex items-center justify-center">
                            <i class="lab-fill-3d-square text-[#6E7191] text-2xl"></i>
                        </div>

                        <div>
                            <h4 class="text-sm">Total Products</h4>
                            <h3 class="text-lg font-bold">
                                {{ sellerProducts.total_products ?? 0 }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 md:col-4">
                    <div class="border flex items-center gap-4 p-4 rounded-lg">
                        <div class="bg-[#F7F7F7] w-12 h-12 rounded-full flex items-center justify-center">
                            <i class="lab-fill-variation text-[#6E7191] text-2xl"></i>
                        </div>

                        <div>
                            <h4 class="text-sm">Sold Quantity</h4>
                            <h3 class="text-lg font-bold">
                                {{ sellerProducts.total_sold_quantity ?? 0 }}
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 md:col-4">
                    <div class="border flex items-center gap-4 p-4 rounded-lg">
                        <div class="bg-[#F7F7F7] w-12 h-12 rounded-full flex items-center justify-center">
                            <i class="lab-fill-dollar-circle text-[#6E7191] text-2xl"></i>
                        </div>

                        <div>
                            <h4 class="text-sm">Total Earning</h4>
                            <h3 class="text-lg font-bold">
                                {{ sellerProducts.total_earning ?? 0 }}
                            </h3>
                        </div>
                    </div>
                </div>
            ...
            <div class="db-table-responsive">
                ...
                <table class="db-table stripe">
                    ...
                    <tbody v-if="sellerProducts.products?.length > 0">

                        <tr v-for="product in sellerProducts.products" :key="product.id">
                            ...
                            <td>
                                {{ Math.abs(product.product_orders_sum_quantity) }}
                            </td>
...
export default {
    ...
    computed: {
        sellerProducts() {
        return this.$store.getters['productsReport/sellerProducts']
    },
        employee: function () {
            return this.$store.getters["seller/show"];
        },
        myOrders: function () {
    ...
    mounted() {
        ...
        this.$store.dispatch("seller/show", this.$route.params.id).then((res) => {
    ...
    methods: {
         fetchSellerProducts() {
        this.$store.dispatch('productsReport/sellerProducts', this.$route.params.id)
            .then(() => {})
