    ...
    <div class="col-12">
        <div class="db-card db-tab-div active">
            ...
            <div class="row px-5 mt-5 mb-5">
                ...
                <div class="col-12 sm:col-6 md:col-4 lg:col-6 xl:col-4" v-if="isSeller">
    <div class="border flex items-center gap-4 p-4 rounded-lg">
        <div class="bg-[#F7F7F7] w-12 h-12 rounded-full flex items-center justify-center">
        ...
        <div>
            ...
            {{ (productsReportOverview.total_earning - (productsReportOverview.total_earning * (authInfo?.seller_info?.commission || 0) / 100)).toFixed(2) }}
            </h4>
        </div>
    </div>
</div>
                ...
                <table class="db-table stripe" id="print">
                    <thead class="db-table-head">
                        <tr class="db-table-head-tr">
                            ...
                            <th class="db-table-head-th">Shop Name</th>
                        </tr>
                    </thead>
                    <tbody class="db-table-body" v-if="productsReports.length > 0">
                        <tr class="db-table-body-tr" v-for="productsReport in productsReports" :key="productsReport">
                            ...
                            <td class="db-table-body-td">{{ productsReport.company_name }}</td>
                        </tr>
                    </tbody>
...
export default {
    ...
    computed: {
        ...
        isSeller: function () {
            return this?.authInfo?.seller_info?.role == 'seller';
        },
